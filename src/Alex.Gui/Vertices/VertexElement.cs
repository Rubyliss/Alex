...
namespace Alex.Engine.Vertices
{
	...
	public partial struct VertexElement : IEquatable<VertexElement>
	{
		...
		private VertexElementSemantic _usage;
		...
		public VertexElementSemantic VertexElementUsage
		{
			get { return _usage; }
			set { _usage = value; }
		}
		...
		public VertexElement(int offset, VertexElementFormat elementFormat, VertexElementSemantic elementUsage, int usageIndex)
		{
			_offset = offset;
